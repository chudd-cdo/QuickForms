          ...
          <div className="chudd-action-icons">
            {archivedView ? (
              ...
              <FaEdit
                ...
                onClick={() => navigate(`/edit-form/${row.original.id}`)}
              />
            )}
            {!archivedView && (
              <FaTrash
    ...
    <div className="chudd-myforms-container">
      <div className="chudd-sidebar">
        <div className="chudd-menu-item" onClick={() => navigate("/dashboard")}>
          <FaHome className="chudd-icon" /> <span>Dashboard</span>
        </div>
        <div className="chudd-menu-item" onClick={() => navigate("/forms")}>
          <FaWpforms className="chudd-icon" /> <span>My Forms</span>
        </div>
        <div className="chudd-menu-item" onClick={() => navigate("/responses")}>
          <FaRegFileAlt className="chudd-icon" /> <span>Responses</span>
        </div>
        <div className="chudd-menu-item">
          <FaSignOutAlt className="chudd-icon" /> <span>Logout</span>
        </div>
      </div>
              ...
              <div className="chudd-modal-overlay">
                <div className="chudd-modal">
                  ...
                  <div className="chudd-modal-body">
                    ...
                    <input type="text" placeholder="Enter Form Name Here" value={formTitle} onChange={(e) => setFormTitle(e.target.value)} />
                    <label>Form Description</label>
                    <textarea placeholder="Enter Description Here" value={formDescription} onChange={(e) => setFormDescription(e.target.value)} />
                  </div>
